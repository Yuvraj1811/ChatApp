      ...
      <div className="flex flex-col gap-10 w-[80vw] md:w-max">
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            {hovered && (
              <div
                className="absolute insert-0 flex items-center justify-center bg-black/50 ring-fuchsia-50 rounded-full"
            ...
            <input onClick={handleFileInputClick}
              type="file"
              ref={fileInputRef}
              className="hidden"
